...
const SUBCATEGORIES = ['Parfum Femme', 'Parfum Homme']
...
export default function ParfumsPage() {
  ...
  const filteredProducts = products.filter((product) => {
    if (product.category !== 'PARFUM') return false
    ...
    <div className="min-h-screen bg-[#f5f5f3]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 md:py-16">
        ...
        <div className="mb-10 border-b border-black/10 pb-10">
          ...
          <h1 className="text-3xl md:text-5xl font-serif text-black mb-2">Parfums</h1>
