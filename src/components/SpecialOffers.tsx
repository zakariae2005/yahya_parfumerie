    ...
    return (
      <section className="py-16 md:py-20 bg-[#f5f5f3] border-t border-b border-black/10">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-serif mb-8 text-black">Offres spéciales</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-white overflow-hidden animate-pulse border border-black/5 shadow-sm">
  ...
  if (error) {
    return (
      <section className="py-16 md:py-20 bg-[#f5f5f3] border-t border-b border-black/10">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-serif mb-8 text-black">Offres spéciales</h2>
          <div className="text-center py-12 bg-white border border-black/5 shadow-sm">
    ...
    <section className="py-10 md:py-16 bg-[#f5f5f3] border-t border-b border-black/10">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-black/40 mb-2">Promotions</p>
            <h2 className="text-3xl md:text-4xl font-serif text-black">Produits en promotion</h2>
          </div>
