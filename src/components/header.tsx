...
export function Header() {
  ...
  const categoryLinks = [
    ...
    { label: 'SOINS DE VISAGE', href: '/soin-visage' },
  ...
  return (
    <>
      ...
      <div className={`w-full bg-black border-b border-white/10 z-40 ${isRTL ? 'rtl' : 'ltr'}`}>
        <div className="max-w-[1400px] mx-auto px-4 md:px-6">
          <div className="relative flex items-center justify-between h-20 md:h-24">
            ...
            {/* Logo */}
            <Link href="/" className="absolute left-1/2 -translate-x-1/2 h-36 md:h-48 w-56 md:w-72">
      ...
      {/* ── STICKY NAV — only this part sticks ── */}
      <nav className={`hidden md:flex sticky top-0 w-full bg-black border-b border-white/10 z-50 -mb-px ${isRTL ? 'rtl' : 'ltr'}`}>
        <div className="max-w-[1400px] mx-auto px-4 md:px-6 w-full">
          <div className="flex items-center justify-center gap-6 lg:gap-20 py-4 relative">
            {categoryLinks.map((item) => {
              const hasMenu = !!megaMenuData[item.href]
